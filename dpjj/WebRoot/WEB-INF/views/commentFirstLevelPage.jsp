...
<div class="container" style="">
	...
	<div id="carousel_container" class="container" style="border:2px solid #dff">
    	<div class="row" >
		...
		<!-- Indicators -->
					...
					<div class="carousel-inner">
						<div class="item active" id="7_8_9">
			  				<img src="../../images/test/1.jpg" alt="First slide">
			  				<div class="container">
						...
						<div class="item" id="1_2_3">
			  				<img src="../../images/test/2.jpg" alt="Second slide">
			  				<div class="container">
								<div class="carousel-caption">
				  					<h1>Title Two</h1>
						...
						<div class="item" id="4_5_6">
			  				<img src="../../images/test/3.jpg" alt="Third slide">
			  					<div class="container">
									<div class="carousel-caption">
				  						<h1>Title Tree</h1>
				  						<p>hello in there</p>
	  ...
	  <form class="form-inline" role="search">
	    <div class="row" style="margin:0px 0px 20px 0px;background-color:#C33">
		  ...
		  <div class="form-group col-xs-6 col-md-3 col-md-offset-3 input-group-lg" >
		    <input type="text" class="form-control" placeholder="企业名称" style="margin:10px 0px">
		  </div>
    ...
    <div id="content_container" class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4 small_paper" >
		  <div class="row">
		    <div class="col-xs-4 col-md-12">
			  <img class="img-responsive " id="567" src="../../images/test/baoxian1.jpg" alt="first">
			</div>
            <div class="row col-xs-8 col-md-12">
			  <div class="col-xs-12 col-md-12">
			    <h2 class="insurance-title">中国人保</h2>
			  </div>
            </div>
          </div>
        </div><!-- /.col-lg-4 -->
		<div class="col-lg-4 small_paper" >
		  <div class="row">
            ...
            <div class="row col-xs-8 col-md-12">
			  <div class="col-xs-12 col-md-12">
			    <h2 class="insurance-title">生命人寿</h2>
			  </div>
		...
		<div class="col-lg-4 small_paper">
		  <div class="row">
            ...
            <div class="row col-xs-8 col-md-12">
			  <div class="col-xs-12 col-md-12">
			    <h2 class="insurance-title">安华保险</h2>
			  </div>
      ...
      <div class="row">
		<div class="col-lg-4 small_paper">
		  <div class="row">
            ...
            <div class="row col-xs-8 col-md-12">
			  <div class="col-xs-12 col-md-12">
			    <h2 class="insurance-title">太平洋保险</h2>
			  </div>
		...
		<span class="visible-md visible-lg">
			<div class="col-md-2 col-lg-2 ">
  				<ul class="pager pager-lg">
    				<li id="" class="next previous_page"><a >上一页</a></li>
    			</ul>
  			</div>
	...
	<script type="text/javascript">
		...
		function render_div(lines){
			...
			for(var line in res.data.lines){
				panel+="<div class=\"col-lg-3 small_paper\"><div class=\"row\">"
					+"<div class=\"col-xs-4 col-md-12\">"					
					+"<img class=\"img-responsive\"  id=\""
					++line.id
					+"\" src=\"" 
					+ line.img_path                                                 
					+"\" alt=\"first\"></div><div class=\"row col-xs-8 col-md-12\">"
		...
		$(document).ready(function(){
			render_nav(start);
			$("#content_container .img-responsive").on("click",function(){
				var id=$(this).attr("id");
				window.location.href="showsmallpaper?id="+id
			})
