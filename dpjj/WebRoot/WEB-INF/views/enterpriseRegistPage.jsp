...
<script type="text/javascript">
	var inputArr=["#nick","#password","#password_again","#other_email",
	              "#code","#enterprise_name","#representive_name","#representive_id","#proof_num","#proof","#phone_num"];
	var tipArr=["#nick_info","#pwd_info","#password_again_info","#email_info","#code_info",
	            "#enterprise_name_info","#representive_id_info","#representive_id_info","#proof_num_info","#proof_info","#phone_info"];
...
<body>
			...
			<div class="content">
				<div class="left" id="lleft">
					<a id="nav_1" class="nav_box" href="javascript:void(0);"
						...
						<span class="dt nav_1">企业帐号注册</span> <span class="dd">企业用户注册通道</span> 
					</a> 	
				</div>
				...
				<div class="right" id="rright">
					...
					<div class="enterA" id="enterA" style="display: block;">
						...
						<div class="haomaTitle" id="hmtitle">
							<div class="haoma-inner" id="haoma-inner">账号信息</div>
						</div>
						<script type="text/javascript">
						...
						function checkTelAndEmail(obj){
						    ...
						    if(obj.id=="other_email"&&(isEmail.test(value)||value=="")){
						    	...
						    	$("#email_info").html("该号码串不是电子邮箱，请重新输入")
						...
						<form enctype="multipart/form-data" method="post" name="fileinfo">
							<div id="formArea">
								...
								<div class="box box_3" style="z-index:0">
									<label class="item" for="nick">企业用户昵称</label>
											...
											<div class="ipt_other">
												<div id="other_email_bg" class="bg_txt">
													<input id="other_email" type="text" class="new_txt"
														...
														maxlength="38" onclick="hideTip(this)" onblur="checkTelAndEmail(this);"/>
												</div>
											</div>
										</div>
										<div class="info ">
						...
						<div class="haomaTitle" id="hmtitle" style="margin:50px auto 20px auto">
							<div class="haoma-inner" id="haoma-inner">企业信息</div>
						</div>
							<script type="text/javascript">
							function checkID(obj){
							    
							    var value=obj.value.trim();
							    if(isIDCard1.test(value)||value==""){
							    	$("#representive_id_info").html("请输入联系人身份证号")
							        return true
							    }else{
							    	$("#representive_id_info").html("该号码串不是身份证号，请重新输入")
							    	$("#representive_id_info").attr("class","tip");
							        return false;
							    }
							}
							function checkProofNum(obj){
							    
							    var value=obj.value.trim();
							    if(isProofNum.test(value)||value==""){
							    	$("#proof_num_info").html("请输入联系人身份证号")
							        return true
							    }else{
							    	$("#proof_num_info").html("该号码串不是身份证号，请重新输入")
							    	$("#proof_num_info").attr("class","tip");
							        return false;
							    }
							}
							...
							<div id="formArea">
								...
								<div class="box box_3" style="z-index:0">
									<label class="item" for="nick">企业全称</label>
									<div class="ipt_box nick_ipt_box">
										<div id="enterprise_name_bg" class="bg_txt">
											<input type="text" class="new_txt" id="enterprise_name" name="enterprise_name"
												tabindex="6" style="z-index:0" maxlength="24"
												autocomplete="off" onclick="hideTip(this)">
										</div>
									</div>
									<div class="info">
										<table>
											<tbody>
												<tr>
													<td id="enterprise_name_info" class="tip hidden">请输入完整的企业全称</td>
												</tr>
											</tbody>
										</table>
									</div>
								...
								<div class="box box_3" style="z-index:0">
									<label class="item" for="nick">联系人姓名</label>
									<div class="ipt_box nick_ipt_box">
										<div id="representive_name_bg" class="bg_txt">
											<input type="text" class="new_txt" id="representive_name" name="representive_name"
												tabindex="6" style="z-index:0" maxlength="24"
												autocomplete="off" onclick="hideTip(this)">
										</div>
									</div>
									<div class="info">
										<table>
											<tbody>
												<tr>
													<td id="representive_name_info" class="tip hidden">请输入联系人姓名</td>
												</tr>
											</tbody>
										</table>
									</div>
								...
								<div id="phone_box" class="phone_box_land ">
									<div id="representive_id_land" class="box box_2 land_phone">
										<label class="item" for="phone_num"><span
											style="display:inline-block;text-align:center">联系人身份证号</span></label>
										<div id="" class="ipt_box">
											<div class="ipt_other">
												<div id="representive_id_bg" class="bg_txt">
													<input id="representive_id" type="text" class="new_txt"
														name="representive_id" tabindex="20" autocomplete="off" onclick="hideTip(this)" onblur="checkID(this)"/>
										...
										<div class="info">
											<table>
												<tbody>
													<tr>
														<td id="representive_id_info" class="tip hidden">请输入联系人身份证号</td>
													</tr>
												</tbody>
											</table>
										</div>
								...
								<div id="phone_box" class="phone_box_land ">
									<div id="proof_num_land" class="box box_2 land_phone">
										<label class="item" for="phone_num"><span
											style="display:inline-block;text-align:center">企业营业执照注册号</span></label>
										<div id="" class="ipt_box">
											<div class="ipt_other">
												<div id="proof_num_bg" class="bg_txt">
													<input id="proof_num" type="text" class="new_txt"
														name="proof_num" tabindex="20" onclick="hideTip(this)" onblur="checkProofNum(this)"/>
										...
										<div class="info">
											<table>
												<tbody>
													<tr>
														<td id="proof_num_info" class="tip hidden">请输入企业营业执照注册号</td>
													</tr>
												</tbody>
											</table>
										</div>
								...
								<div class="box box_3" style="z-index:0">
									<label class="item" for="nick">企业资质证明材料</label>
									<div class="ipt_box nick_ipt_box">
										<div id="proof_name_bg" class="bg_txt">
											<input type="file" class="new_txt" id="proof" accept="image/jpeg" name="proof" tabindex="6" style="z-index:0" maxlength="24"
												 onclick="hideTip(this)" />
									...
									<div class="info">
										<table>
											<tbody>
												<tr>
													<td id="proof_info" class="tip hidden">请上传企业证明材料</td>
												</tr>
											</tbody>
										</table>
									</div>
								...
								<div id="phone_box" class="phone_box_land " >
									...
									<div id="land_phone" class="box box_2 land_phone" style="margin:50px 0px;padding:30px 0px">
										<label class="item" for="phone_num"><span
											...
											<div class="ipt_other">
												<div id="phone_num_bg" class="bg_txt">
													<input id="phone_num" type="text" class="new_txt"
														name="phone_num" tabindex="20" onclick="hideTip(this)" onblur="checkTelAndEmail(this);"/>
										...
										<div class="info">
											<table>
												<tbody>
													<tr>
														<td id="phone_info" class="tip hidden">请输入联系电话</td>
													</tr>
												</tbody>
											</table>
										</div>
	...
	$(document).ready(function(e) {
		$("#submit").click(function(){
			...
			//alert("成功")
			$.ajax({  
		          url: './checkEnterpriseUserRegistPage.html' ,  
		          type: 'POST',  
		          data: formData,  
		          async: false,  
		          cache: false,  
